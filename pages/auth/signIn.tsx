...
const signIn = () => {
  ...
  return (
    ...
    <div className="flex flex-col gap-3 lg:w-5/12 w-full">
        ...
        <span className="flex text-dark lg:w-3/6 w-full gap-3"><div className="w-full h-1 rounded-full bg-dark my-auto align-middle"></div> OR <div className="w-full h-1 rounded-full bg-dark my-auto align-middle"></div></span>
        <form onSubmit={(e) => {
          e.preventDefault();
