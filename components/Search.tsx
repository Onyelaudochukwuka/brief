...
const Search:NextComponentType = () => {
  return (
    <legend className="mx-auto w-11/12 text-center p-8 bg-primaryDark  bg-[url('../images/bg-boost-desktop.svg')] bg-[length:175%] bg-center gap-6 flex flex-row rounded-lg">
